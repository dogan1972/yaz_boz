...
class _EllerSayfasiState extends State<EllerSayfasi> {
  ...
  Widget _altPanelButonlariniOlustur(
    BuildContext ctx,
    Map<String, int> sonuclar,
    List<String> eller,
  ) {
    return Padding(
          ...
          Expanded(
            ...
            child: OutlinedButton.icon(
              onPressed: () => Navigator.push(
                ctx,
                MaterialPageRoute(builder: (c) => const OyunlarSayfasi()),
              ),
            ...
            child: OutlinedButton.icon(
              onPressed: () async {
                ...
                final Uri whatsappUrl = Uri.parse(
                  "whatsapp://send?text=${Uri.encodeComponent(skorTablosu)}",
                );
